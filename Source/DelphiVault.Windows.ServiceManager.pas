...
unit DelphiVault.Windows.ServiceManager;
...
begin
  ...
  ResumeHandle := 0;
  Services := nil;
  if EnumServicesStatus(FManager, SERVICE_WIN32, SERVICE_STATE_ALL,
...
begin
  if Value then begin
    ...
    if not GetVersionEx(VersionInfo) then RaiseLastOSError;
